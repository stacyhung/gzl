...
#laml.tnm.EBER_pos = trinucleotideMatrix(maf = mutations.EBER_pos.maf, ref_genome = "~/Documents/references/GRCh37-lite.fa", ignoreChr = "chr23", useSyn = FALSE)
laml.tnm.EBER_pos = trinucleotideMatrix(maf = mutations.EBER_pos.maf, prefix = 'chr', ref_genome = "BSgenome.Hsapiens.UCSC.hg19", ignoreChr = "chr23", useSyn = FALSE)
...
# note the input parameters for this function has been updated with the lastest version of maftools
laml.tnm = trinucleotideMatrix(maf = mutations.maf, ref_genome = NULL, prefix = "chr", ignoreChr = "chr23", useSyn = FALSE)
#laml.tnm = trinucleotideMatrix(maf = mutations.maf, ref_genome = "~/Documents/references/GRCh37-lite.fa", ignoreChr = "chr23", useSyn = FALSE)
write.table(laml.tnm, "/Volumes/shung/projects/gzl_exomes/snv_analysis-20181127/signature_analysis/all_mutations-signatures.txt", quote = FALSE)
