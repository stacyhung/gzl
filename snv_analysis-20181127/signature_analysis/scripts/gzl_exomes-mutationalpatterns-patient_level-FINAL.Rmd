...
Idea: double-sided rotated bar plot (akin to a forest plot) showing proportions of each category - each row would be a signature, and each side of the bar plot would represent a different category (e.g. left = EBV-, right = EBV+)
