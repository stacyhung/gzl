...
write.table(med_status_genes.10_plus, "/Volumes/shung/projects/gzl_exomes/data/mediastinal_group_visualization/med_status_genes.10_plus.txt", quote = FALSE, row.names = FALSE)
...
write.table(mutations.df, "/Volumes/shung/projects/gzl_exomes/snv_analysis-20181127/snv_indel_datasets/maf/gzl_exomes-snvs_indels.filtered_med_status_group.maf", sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(mutation.matrix, "/Volumes/shung/projects/gzl_exomes/data/mediastinal_group_visualization/mutation_matrix-mediastinal_groups_10+_freq_mutated.txt", sep = "\t", quote = FALSE)
```
...
write.table(mut.oncoplot, "/Volumes/shung/projects/gzl_exomes/data/mediastinal_group_visualization/mutation_matrix-mediastinal_groups_10+_freq_mutated.oncoplot.txt", sep = "\t", quote = FALSE)
...
clinical.data <- read.table("/Volumes/shung/projects/gzl_exomes/data/GZ_WES_cases-clinical_data.with_updated_mediastinal_and_age.txt", sep = "\t", header = TRUE)
#clinical.data$Path_group <- revalue(clinical.data$Path_group, c("0 = cHL"="0_=_cHL", "1 = cHL-interm"="1_=_cHL-interm", "2 = LBCL-interm"="2_=_LBCL-interm", "3 = LBCL"="3_=_LBCL"))
