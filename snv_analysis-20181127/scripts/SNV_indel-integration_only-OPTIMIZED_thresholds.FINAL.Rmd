...
write.table(calls.validation, "/Volumes/shung/projects/gzl_exomes/snv_analysis-20181127/snv_indel_datasets/t_v_me.all/snvs_indels.t_v_me.validation_cohort.OPTIMIZED_thresholds.txt", sep = "\t", quote = FALSE, row.names = FALSE)
