...
varscan.paired.calls.T_v_ME$thresholds <- "SPV < 0.175; VAF normal < 15%"
...
write.table(varscan.paired.calls, "/Volumes/shung/projects/gzl_exomes/snv_analysis-20181127/snv_indel_datasets/t_v_me.all/varScan/varScan-t_v_me_all-snvs_indels-filtered_optimized.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(calls.all, "/Volumes/shung/projects/gzl_exomes/snv_analysis-20181127/snv_indel_datasets/t_v_me.all/snvs_indels.t_v_me.OPTIMIZED_thresholds.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(calls.not_validation, "/Volumes/shung/projects/gzl_exomes/snv_analysis-20181127/snv_indel_datasets/t_v_me.all/snvs_indels.t_v_me.not_validation_cohort.OPTIMIZED_thresholds.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(calls.not_validation, "/Volumes/shung/projects/gzl_exomes/snv_analysis-20181127/snv_indel_datasets/t_v_me.all/snvs_indels.t_v_me.validation_cohort.OPTIMIZED_thresholds.txt", sep = "\t", quote = FALSE, row.names = FALSE)
