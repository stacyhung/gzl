...
write.table(eber_genes.10_plus, "/Volumes/shung/projects/gzl_exomes/data/EBV_visualization/eber_genes.10_plus-v_incl_GZ222.txt", quote = FALSE, row.names = FALSE)
...
write.table(mutations.df, "/Volumes/shung/projects/gzl_exomes/snv_analysis-20181127/snv_indel_datasets/maf/gzl_exomes_incl_GZ222-snvs_indels.filtered_eber_status.maf", sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(mutation.matrix, "/Volumes/shung/projects/gzl_exomes/data/EBV_visualization/mutation_matrix-incl_GZ222-eber_groups_10+_freq_mutated.txt", sep = "\t", quote = FALSE)
...
write.table(mut.oncoplot, "/Volumes/shung/projects/gzl_exomes/data/EBV_visualization/mutation_matrix-incl_GZ222-eber_groups_10+_freq_mutated.oncoplot.txt", sep = "\t", quote = FALSE)
```
...
oncoplot(maf = mutations.maf, SampleNamefontSize = 0.65,
